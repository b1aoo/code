...
END_NUM = 50   # 结束作文编号
# ======================================================
def grade_essay_no_change(essay_content, DASHSCOPE_API_KEY,model_name):
...
def process_essay(input_num, root_dir, output_dir):
    ...
    try:
        ...
        result_none = grade_essay_no_change(content, DASHSCOPE_API_KEY,'deepseek-v3.2')
...
if __name__ == "__main__":
    # 修改路径配置（移除 file_path）
    root_dir = r'D:\zuowen\data\zero_shot'
    output_dir = r"D:\zuowen\data\eval\temp\zero_shot"  # 输出目录
