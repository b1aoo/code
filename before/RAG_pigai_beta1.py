...
from llm_func import grade_essay_test, similar_grade_content,similar_grade_structure,similar_grade_language,join_result,grade_essay_origin,extract_problem_types
...
if __name__ == "__main__":
    ...
    output_dir = r"D:\zuowen\data\eval\temp\cz"  # 输出目录
